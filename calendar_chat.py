...
class ChatCalendar:
    def __init__(self):
        self.calendar_data = pd.read_csv('./Data/Calendar/kyrill_calendar.csv')
        ...
        self.db = FAISS.load_local("./Vector_DBs/jan_chats_100_20", OpenAIEmbeddings())
    ...
    def get_relevant_calendar_event(self, query):
        ...
        cd = pd.read_csv('./Data/Calendar/kyrill_calendar.csv')
    ...
    def test(self, query):
        prompt_template = open('./Prompt_Templates/chat_calendar.txt', "r")
